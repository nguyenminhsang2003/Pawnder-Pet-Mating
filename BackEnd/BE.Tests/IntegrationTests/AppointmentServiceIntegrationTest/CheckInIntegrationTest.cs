...
/// <summary>
/// Integration Tests cho CheckIn API
/// POST /api/appointment/{appointmentId}/check-in
/// </summary>
public class CheckInIntegrationTest : IClassFixture<CustomWebApplicationFactory>
{
    private readonly CustomWebApplicationFactory _factory;

    public CheckInIntegrationTest(CustomWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    [Fact]
    public async Task UC_6_8_TC_1_CheckIn_WithValidGPS_ReturnsSuccess()
    {
        // Arrange
        ...
        // Act
        var response = await client.PostAsync("/api/appointment/1/check-in", content);
    ...
    [Fact]
    public async Task UC_6_8_TC_2_CheckIn_WithInvalidLocation_ReturnsBadRequest()
    {
        // Arrange - Coordinates far from HCM (Hanoi coordinates)
        var client = CreateAuthenticatedClient(10);
        var requestBody = new
        {
            latitude = 21.0285m,
    ...
    [Fact]
    public async Task UC_6_8_TC_3_CheckIn_NonExistent_ReturnsNotFound()
    {
        // Arrange
        var client = CreateAuthenticatedClient(10);
        var requestBody = new
        ...
        // Act
        var response = await client.PostAsync("/api/appointment/99999/check-in", content);
    ...
    [Fact]
    public async Task UC_6_8_TC_4_CheckIn_WithoutAuth_ReturnsUnauthorized()
    {
        // Arrange
        var client = _factory.CreateClient();
        var requestBody = new
