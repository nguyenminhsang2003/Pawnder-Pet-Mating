...
/// <summary>
/// Integration Tests cho GetAcceptHistory API
/// GET /api/policies/history
/// </summary>
public class GetAcceptHistoryIntegrationTest : IClassFixture<CustomWebApplicationFactory>
{
    private readonly CustomWebApplicationFactory _factory;

    public GetAcceptHistoryIntegrationTest(CustomWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    [Fact]
    public async Task UC_9_19_TC_1_GetAcceptHistory_AsUser_ReturnsList()
    {
        var client = CreateUserClient();
        var response = await client.GetAsync("/api/policies/history");
        Assert.True(
    ...
    [Fact]
    public async Task UC_9_19_TC_2_GetAcceptHistory_AsAdmin_ReturnsList()
    {
    ...
    [Fact]
    public async Task UC_9_19_TC_3_GetAcceptHistory_WithoutAuth_ReturnsUnauthorized()
    {
        var client = _factory.CreateClient();
        var response = await client.GetAsync("/api/policies/history");
        Assert.True(
